         ...
         if ($result = $mysqli->query($query)) {
             while ($row = $result->fetch_assoc()) {
                 ...
                 echo '<tr> 
                           ...
                           <td><a style="color: red;" href="delUp.php?bookid='.$bookid.'" data-toggle="tooltip" data-placement="right" title="DELETE"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                       </tr>';
             }
             $result->free();
         } 
...
<br><br>
  ...
  All rights reserved RexBooks 2020</p>
    ...
    <script> function submitForm() { 
         document.registration.submit(); // document.serviceform.reset(); } 
      </script>
      <script> 
