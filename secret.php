...
<html lang="en" dir="ltr">
   ...
   <body>
      ...
      <?php 
         ...
         $query = "SELECT * FROM `BookDB` WHERE `BookID`='8'";
      ...
      <div class="row">
         <div class="col-lg-4 col-md-6">
            <img src="bookCovers/classics/theSecretGarden.jpg" alt="" width="70%" height="80%" style="margin: 5%; padding: 2%;" data-aos="flip-left">
         </div>
         <div class="col-lg-4 col-md-6" data-aos="flip-right">
            ...
            <?php
               ...
               <br>
               <h3 class="shadow-lg">'.$Description.'</h3>
               ...
               <a  href="'.$file.'" download><button class="button"><span>Download</span></button></a>
               ';
                        ?>
            <br><br>
               <button onclick="like()"><i class="fas fa-2x fa-heart"></i></button><span id="btspan" style="color: white; display: none;">count</span><br><span id="bttemp" style="color: white; display: inline;">45</span>
               <!-- AddToAny BEGIN -->
      ...
      <div  id="comment">
         ...
         <?php
            ...
            $_SESSION['idvar'] = '8';
            $mysqli = new mysqli("localhost", $username, $password, $database); 
            $query = "SELECT * FROM Cooments WHERE BookID = '8' ";
            $queryJoin = "SELECT c.Comments FROM Cooments c JOIN BookDB b ON c.BookID b.BookID";
            if ($result = $mysqli->query($query)) {
                while ($row = $result->fetch_assoc()) {
            ...
            ?>
         <form method="post" name="comment" action="secret.php">
