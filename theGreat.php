...
<html lang="en" dir="ltr">
   ...
   <body>
      ...
      <?php 
         ...
         $query = "SELECT * FROM `BookDB` WHERE `BookID`='6'";
      ...
      <div class="row">
         <div class="col-lg-4 col-md-6">
            <img src="bookCovers/classics/greatExpectations.jpg" alt="" width="70%" height="80%" style="margin: 5%; padding: 2%;" data-aos="flip-left">
         </div>
      ...
      <div  id="comment">
         ...
         <?php
            ...
            $_SESSION['idvar'] = '6';
            $mysqli = new mysqli("localhost", $username, $password, $database); 
            $query = "SELECT * FROM Cooments WHERE BookID = '6' ";
            ...
            ?>
         <form method="post" name="comment" action="theGreat.php">
